...
;------------------------------------------------------------------------------
; header.asm - GBA ROM header.
;------------------------------------------------------------------------------

ROMHeader:
    dw        0xEA00002E ; branch to entry point 80000C0h
    ...
    db        "MARIMOD", 0, 0, 0, 0, 0 ; Game Title
    db        "CMMP"                   ; Game Code
    db        "00"                     ; Maker Code
    db        0x96                     ; 96h
    db        0                        ; Unit Code
    db        0, 0, 0, 0, 0, 0, 0, 0   ; Device Type and 7x 0
    db        0                        ; Software Version
    db        0xBB                     ; Header Checksum
    db        0, 0                     ; 2x 0
